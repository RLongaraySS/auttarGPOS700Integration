package com.example.auttargpos700integration;
...
*/
    ...
    /**
     * Método que faz a impressão de imagens em String64
     *
     * @param bytes = imagem em bytes
     *
     * @throws IllegalArgumentException = Argumento passado ilegal
     * @throws GediException = retorna o código do erro.
     *
     * */
    public boolean imprimeImagem64(byte[] bytes) throws GediException {
